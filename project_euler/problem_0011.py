...
def get_adjacent_numbers(x, y):
    # If we fail with an IndexError it doesn't really matter because eventually we will get it!
    ...
    try:
        ...
        for direction in directions:
            largest_product = max(largest_product, reduce(mul, direction))
...
for i, row in enumerate(grid):
    for j, value in enumerate(row):
        largest_product = max(largest_product, get_adjacent_numbers(i, j))
